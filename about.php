<?php
	...
	$page_title="About Us";
	$page_content="
		<style>.pge-h{color:black;}#about-div{width:60%;margin-left:20%;margin-right:20%;}</style>
		<center><h1 class=\"pge-h\">About</h1></center>
		<div id=\"about-div\" class=\"contaner-fluid\">
			<div class=\"row\">
				<div class=\"col-md-12\">
					<p class=\"desc\">
